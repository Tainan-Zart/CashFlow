...
public class RegisterExpenseValidator : AbstractValidator<RequestRegisterExpenseJson>
{
    ...
    {
        RuleFor(expense => expense.Title).NotEmpty().WithMessage(ResourceErrorMessages.UNKNOWN_ERROR);
        ...
        RuleFor(expense => expense.PaymentType).IsInEnum().IsInEnum().WithMessage(ResourceErrorMessages.PAYMENT_TYPE_INVALID);
    }
}
